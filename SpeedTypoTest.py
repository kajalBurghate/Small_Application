# Python program to check Speed Typing Test
...
def speed_test() :
    speed_test_sentences = [
        'This is a random sentenance to check speed.',
        'speed, I amd lightening mcqueen.'
    ]

    sentences = random.choice(speed_test_sentences)
    start = timer()
    main_window = tkinter.Tk()
    main_window.geometry('600x400')

    label_1 = tkinter.Label(main_window, text = sentences, font = 'times20')
    label_1.place(x = 150, y = 10)

    label_2 = tkinter.Label(main_window, text = 'Start Typing', font = 'times20')
